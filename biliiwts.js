...
module.exports = async (ctx) => {
    ...
    const { mid, platform, token, web_location,  wbiImgKey, wbiSubKey} = ctx.request.query;
    const a = {
        mid: mid ? mid : body.mid ? body.mid : '', 
        platform: platform ? platform : body.platform ?body.platform: 'web', 
        token: token ? token : body.token ?body.token: '', 
        web_location: web_location ? web_location : body.web_location ?  body.web_location: '1550101'
    };
    const b = {
        wbiImgKey: wbiImgKey ? wbiImgKey : body.wbiImgKey ? body.wbiImgKey: '4a1d4479a1ea4146bc7552eea71c28e9',
        wbiSubKey: wbiSubKey ? wbiSubKey : body.wbiSubKey ? body.wbiSubKey : 'fa5812e23a204d10b332dc24d992432d'
        };
    
    const data= !a.mid ? null : encode(a, b);    
